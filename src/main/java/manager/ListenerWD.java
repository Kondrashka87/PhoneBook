...
public class ListenerWD implements WebDriverListener
{
    ...
    public void onError(Object target, Method method, Object[] args, InvocationTargetException e)
    {
        ...
        logger.info("*******************");
        //logger.info("InvocationTarget getMessage()" + e.getMessage());
       // logger.info("*******************");
        logger.info("InvocationTarget getTargetException()" + e.getTargetException());
        logger.info("*******************");
//        logger.info("InvocationTarget getCause()" + e.getCause());
//        logger.info("*******************");
        logger.info("Object target" + target.toString());
        logger.info("*******************");

        WebDriver wd = (ChromeDriver)target;// kasting
